...
class MultiplayerAPI(__refcounted__.RefCounted):
  ...
  @staticmethod
  def create_default_interface()->__multiplayerapiextension__.MultiplayerAPIExtension|__multiplayerapi__.MultiplayerAPI|__scenemultiplayer__.SceneMultiplayer:
    """
