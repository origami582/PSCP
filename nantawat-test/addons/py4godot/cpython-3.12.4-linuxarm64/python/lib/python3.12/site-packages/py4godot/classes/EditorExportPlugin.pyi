...
class EditorExportPlugin(__refcounted__.RefCounted):
  ...
  def _export_file(self, path:str, type:str, features:__core__.PackedStringArray)->None:
    """
  ...
  def _export_begin(self, features:__core__.PackedStringArray, is_debug:bool, path:str, flags:int)->None:
    """
  ...
  def _begin_customize_resources(self, platform:__editorexportplatform__.EditorExportPlatform, features:__core__.PackedStringArray)->bool:
    """
  ...
  def _customize_resource(self, resource:__resource__.Resource, path:str)->__audioeffecthardlimiter__.AudioEffectHardLimiter|__inputeventscreendrag__.InputEventScreenDrag|__texture2drd__.Texture2DRD|__buttongroup__.ButtonGroup|__visualshadernodevec2parameter__.VisualShaderNodeVec2Parameter|__visualshadernodecurvetexture__.VisualShaderNodeCurveTexture|__audiostreamgenerator__.AudioStreamGenerator|__capsulemesh__.CapsuleMesh|__skeletonmodification2dccdik__.SkeletonModification2DCCDIK|__audioeffectreverb__.AudioEffectReverb|__inputeventmousebutton__.InputEventMouseButton|__audioeffectphaser__.AudioEffectPhaser|__visualshadernodetexturesdf__.VisualShaderNodeTextureSDF|__visualshadernodemultiplyadd__.VisualShaderNodeMultiplyAdd|__physicalskymaterial__.PhysicalSkyMaterial|__boxmesh__.BoxMesh|__gltfcamera__.GLTFCamera|__visualshadernodebooleanconstant__.VisualShaderNodeBooleanConstant|__openxractionmap__.OpenXRActionMap|__visualshadernodeclamp__.VisualShaderNodeClamp|__polygonoccluder3d__.PolygonOccluder3D|__pointmesh__.PointMesh|__multimesh__.MultiMesh|__curvetexture__.CurveTexture|__visualshadernodeuvfunc__.VisualShaderNodeUVFunc|__inputeventmagnifygesture__.InputEventMagnifyGesture|__visualshadernodetextureparametertriplanar__.VisualShaderNodeTextureParameterTriplanar|__inputeventjoypadbutton__.InputEventJoypadButton|__inputeventkey__.InputEventKey|__openxranalogthresholdmodifier__.OpenXRAnalogThresholdModifier|__immediatemesh__.ImmediateMesh|__placeholdercubemaparray__.PlaceholderCubemapArray|__visualshadernodegroupbase__.VisualShaderNodeGroupBase|__skeletonmodification2djiggle__.SkeletonModification2DJiggle|__visualshadernodefaceforward__.VisualShaderNodeFaceForward|__visualshadernodedotproduct__.VisualShaderNodeDotProduct|__visualshadernodeswitch__.VisualShaderNodeSwitch|__visualshadernodeparameterref__.VisualShaderNodeParameterRef|__imagetexture__.ImageTexture|__visualshadernodecomment__.VisualShaderNodeComment|__skeletonmodification2dtwoboneik__.SkeletonModification2DTwoBoneIK|__occluder3d__.Occluder3D|__texture2darrayrd__.Texture2DArrayRD|__visualshadernodevectordistance__.VisualShaderNodeVectorDistance|__skeletonprofilehumanoid__.SkeletonProfileHumanoid|__visualshadernodeworldpositionfromdepth__.VisualShaderNodeWorldPositionFromDepth|__audioeffectspectrumanalyzer__.AudioEffectSpectrumAnalyzer|__audioeffecteq10__.AudioEffectEQ10|__visualshadernodetransformconstant__.VisualShaderNodeTransformConstant|__audioeffecteq6__.AudioEffectEQ6|__audiostreamoggvorbis__.AudioStreamOggVorbis|__shaderinclude__.ShaderInclude|__visualshadernodetexture2dparameter__.VisualShaderNodeTexture2DParameter|__curvexyztexture__.CurveXYZTexture|__visualshadernodetransformdecompose__.VisualShaderNodeTransformDecompose|__audiostreamsynchronized__.AudioStreamSynchronized|__segmentshape2d__.SegmentShape2D|__inputeventmouse__.InputEventMouse|__gltfskin__.GLTFSkin|__voxelgidata__.VoxelGIData|__panoramaskymaterial__.PanoramaSkyMaterial|__gltfdocumentextension__.GLTFDocumentExtension|__gdscript__.GDScript|__audioeffectlowshelffilter__.AudioEffectLowShelfFilter|__audioeffecteq__.AudioEffectEQ|__styleboxempty__.StyleBoxEmpty|__portablecompressedtexture2d__.PortableCompressedTexture2D|__videostreamtheora__.VideoStreamTheora|__visualshadernodeparticlesphereemitter__.VisualShaderNodeParticleSphereEmitter|__animation__.Animation|__animationnodeblend2__.AnimationNodeBlend2|__fontfile__.FontFile|__prismmesh__.PrismMesh|__arraymesh__.ArrayMesh|__ribbontrailmesh__.RibbonTrailMesh|__oggpacketsequence__.OggPacketSequence|__canvasitemmaterial__.CanvasItemMaterial|__meshlibrary__.MeshLibrary|__openxraction__.OpenXRAction|__inputevent__.InputEvent|__meshtexture__.MeshTexture|__visualshadernodeif__.VisualShaderNodeIf|__visualshadernodesdfraymarch__.VisualShaderNodeSDFRaymarch|__audioeffectdelay__.AudioEffectDelay|__tilesetscenescollectionsource__.TileSetScenesCollectionSource|__skeletonmodification2dlookat__.SkeletonModification2DLookAt|__sphereoccluder3d__.SphereOccluder3D|__audioeffecteq21__.AudioEffectEQ21|__videostream__.VideoStream|__json__.JSON|__gltfbufferview__.GLTFBufferView|__visualshadernodeparticlemultiplybyaxisangle__.VisualShaderNodeParticleMultiplyByAxisAngle|__visualshadernodetransformparameter__.VisualShaderNodeTransformParameter|__occluderpolygon2d__.OccluderPolygon2D|__polygonpathfinder__.PolygonPathFinder|__visualshadernodeparticlerandomness__.VisualShaderNodeParticleRandomness|__cryptokey__.CryptoKey|__lightmapgidata__.LightmapGIData|__gltftexturesampler__.GLTFTextureSampler|__animationnodesub2__.AnimationNodeSub2|__inputeventpangesture__.InputEventPanGesture|__openxrbindingmodifier__.OpenXRBindingModifier|__sphereshape3d__.SphereShape3D|__visualshadernodeconstant__.VisualShaderNodeConstant|__texture3d__.Texture3D|__openxrdpadbindingmodifier__.OpenXRDpadBindingModifier|__syntaxhighlighter__.SyntaxHighlighter|__audioeffectpitchshift__.AudioEffectPitchShift|__openxractionbindingmodifier__.OpenXRActionBindingModifier|__visualshadernodeuvpolarcoord__.VisualShaderNodeUVPolarCoord|__proceduralskymaterial__.ProceduralSkyMaterial|__navigationpolygon__.NavigationPolygon|__gltfaccessor__.GLTFAccessor|__visualshadernodeparticleringemitter__.VisualShaderNodeParticleRingEmitter|__texture2darray__.Texture2DArray|__visualshadernodeoutput__.VisualShaderNodeOutput|__inputeventmousemotion__.InputEventMouseMotion|__visualshadernodetexture3d__.VisualShaderNodeTexture3D|__sky__.Sky|__visualshadernodecubemapparameter__.VisualShaderNodeCubemapParameter|__audioeffectlimiter__.AudioEffectLimiter|__visualshadernodebillboard__.VisualShaderNodeBillboard|__visualshadernodesdftoscreenuv__.VisualShaderNodeSDFToScreenUV|__planemesh__.PlaneMesh|__circleshape2d__.CircleShape2D|__visualshadernodecolorop__.VisualShaderNodeColorOp|__animationnodeanimation__.AnimationNodeAnimation|__visualshadernodeouterproduct__.VisualShaderNodeOuterProduct|__visualshadernodevec4parameter__.VisualShaderNodeVec4Parameter|__tilemappattern__.TileMapPattern|__gradient__.Gradient|__gltfstate__.GLTFState|__tileset__.TileSet|__visualshadernodetexture__.VisualShaderNodeTexture|__visualshadernodeuintop__.VisualShaderNodeUIntOp|__visualshadernodetexture3dparameter__.VisualShaderNodeTexture3DParameter|__visualshadernodeparticleemit__.VisualShaderNodeParticleEmit|__scenereplicationconfig__.SceneReplicationConfig|__stylebox__.StyleBox|__separationrayshape2d__.SeparationRayShape2D|__gradienttexture2d__.GradientTexture2D|__noisetexture3d__.NoiseTexture3D|__audiostreaminteractive__.AudioStreamInteractive|__audioeffectdistortion__.AudioEffectDistortion|__visualshadernodeparticleconevelocity__.VisualShaderNodeParticleConeVelocity|__animationnodetimeseek__.AnimationNodeTimeSeek|__visualshadernodereroute__.VisualShaderNodeReroute|__fbxdocument__.FBXDocument|__visualshadernode__.VisualShaderNode|__animationnodestatemachinetransition__.AnimationNodeStateMachineTransition|__animationnodestatemachine__.AnimationNodeStateMachine|__labelsettings__.LabelSettings|__particleprocessmaterial__.ParticleProcessMaterial|__visualshadernodevaryingsetter__.VisualShaderNodeVaryingSetter|__convexpolygonshape2d__.ConvexPolygonShape2D|__texturelayered__.TextureLayered|__visualshadernodecompare__.VisualShaderNodeCompare|__shape2d__.Shape2D|__visualshadernodebooleanparameter__.VisualShaderNodeBooleanParameter|__quadoccluder3d__.QuadOccluder3D|__visualshadernodelinearscenedepth__.VisualShaderNodeLinearSceneDepth|__styleboxflat__.StyleBoxFlat|__audioeffectrecord__.AudioEffectRecord|__visualshadernodeparameter__.VisualShaderNodeParameter|__animationnodeblend3__.AnimationNodeBlend3|__visualshadernoderotationbyaxis__.VisualShaderNodeRotationByAxis|__gltfdocumentextensionconvertimportermesh__.GLTFDocumentExtensionConvertImporterMesh|__openxrhapticbase__.OpenXRHapticBase|__audioeffectpanner__.AudioEffectPanner|__visualshadernodecolorconstant__.VisualShaderNodeColorConstant|__rdshaderspirv__.RDShaderSPIRV|__audioeffecthighshelffilter__.AudioEffectHighShelfFilter|__styleboxline__.StyleBoxLine|__placeholdermaterial__.PlaceholderMaterial|__visualshadernodevectorfunc__.VisualShaderNodeVectorFunc|__imagetexture3d__.ImageTexture3D|__fogmaterial__.FogMaterial|__convexpolygonshape3d__.ConvexPolygonShape3D|__placeholdertexture2d__.PlaceholderTexture2D|__visualshadernodefresnel__.VisualShaderNodeFresnel|__openxractionset__.OpenXRActionSet|__worldboundaryshape3d__.WorldBoundaryShape3D|__visualshadernodeexpression__.VisualShaderNodeExpression|__placeholdercubemap__.PlaceholderCubemap|__audiobuslayout__.AudioBusLayout|__visualshadernodescreenuvtosdf__.VisualShaderNodeScreenUVToSDF|__curve2d__.Curve2D|__gltfnode__.GLTFNode|__visualshadernodederivativefunc__.VisualShaderNodeDerivativeFunc|__visualshadernodedeterminant__.VisualShaderNodeDeterminant|__translation__.Translation|__material__.Material|__viewporttexture__.ViewportTexture|__cylindershape3d__.CylinderShape3D|__visualshadernodefloatconstant__.VisualShaderNodeFloatConstant|__audiostreamplaylist__.AudioStreamPlaylist|__tilesetatlassource__.TileSetAtlasSource|__visualshadernodestep__.VisualShaderNodeStep|__tilesetsource__.TileSetSource|__animationnodeadd2__.AnimationNodeAdd2|__spriteframes__.SpriteFrames|__visualshadernodetransformop__.VisualShaderNodeTransformOp|__audioeffectbandpassfilter__.AudioEffectBandPassFilter|__capsuleshape3d__.CapsuleShape3D|__visualshadernodevectordecompose__.VisualShaderNodeVectorDecompose|__animationnodestatemachineplayback__.AnimationNodeStateMachinePlayback|__packedscene__.PackedScene|__audioeffectlowpassfilter__.AudioEffectLowPassFilter|__visualshadernodeuintconstant__.VisualShaderNodeUIntConstant|__openxrinteractionprofile__.OpenXRInteractionProfile|__animationnodeblendspace1d__.AnimationNodeBlendSpace1D|__visualshader__.VisualShader|__visualshadernodedistancefade__.VisualShaderNodeDistanceFade|__importermesh__.ImporterMesh|__visualshadernodeis__.VisualShaderNodeIs|__skeletonmodification2d__.SkeletonModification2D|__gltfphysicsshape__.GLTFPhysicsShape|__visualshadernodetexture2darrayparameter__.VisualShaderNodeTexture2DArrayParameter|__world3d__.World3D|__rdshaderfile__.RDShaderFile|__bonemap__.BoneMap|__gltfskeleton__.GLTFSkeleton|__placeholdertexture3d__.PlaceholderTexture3D|__gltflight__.GLTFLight|__worldboundaryshape2d__.WorldBoundaryShape2D|__visualshadernodevectorbase__.VisualShaderNodeVectorBase|__compressedtexture2d__.CompressedTexture2D|__placeholdermesh__.PlaceholderMesh|__spheremesh__.SphereMesh|__visualshadernodeproximityfade__.VisualShaderNodeProximityFade|__theme__.Theme|__visualshadernoderandomrange__.VisualShaderNodeRandomRange|__visualshadernodevarying__.VisualShaderNodeVarying|__visualshadernodeparticleoutput__.VisualShaderNodeParticleOutput|__gltfanimation__.GLTFAnimation|__audioeffectbandlimitfilter__.AudioEffectBandLimitFilter|__gdscriptsyntaxhighlighter__.GDScriptSyntaxHighlighter|__visualshadernodeparticlemeshemitter__.VisualShaderNodeParticleMeshEmitter|__audioeffectcapture__.AudioEffectCapture|__editorsyntaxhighlighter__.EditorSyntaxHighlighter|__systemfont__.SystemFont|__concavepolygonshape3d__.ConcavePolygonShape3D|__cylindermesh__.CylinderMesh|__openxripbinding__.OpenXRIPBinding|__texturelayeredrd__.TextureLayeredRD|__audioeffect__.AudioEffect|__audiostreamwav__.AudioStreamWAV|__visualshadernodeglobalexpression__.VisualShaderNodeGlobalExpression|__image__.Image|__cubemap__.Cubemap|__gltfmesh__.GLTFMesh|__visualshadernodeintfunc__.VisualShaderNodeIntFunc|__audioeffectnotchfilter__.AudioEffectNotchFilter|__scriptextension__.ScriptExtension|__audioeffectchorus__.AudioEffectChorus|__visualshadernodefloatop__.VisualShaderNodeFloatOp|__editornode3dgizmoplugin__.EditorNode3DGizmoPlugin|__optimizedtranslation__.OptimizedTranslation|__visualshadernodetransformfunc__.VisualShaderNodeTransformFunc|__inputeventwithmodifiers__.InputEventWithModifiers|__animationnodeoutput__.AnimationNodeOutput|__ormmaterial3d__.ORMMaterial3D|__colorpalette__.ColorPalette|__inputeventjoypadmotion__.InputEventJoypadMotion|__animationnodeblendspace2d__.AnimationNodeBlendSpace2D|__quadmesh__.QuadMesh|__gradienttexture1d__.GradientTexture1D|__standardmaterial3d__.StandardMaterial3D|__heightmapshape3d__.HeightMapShape3D|__visualshadernodeinput__.VisualShaderNodeInput|__visualshadernodeintconstant__.VisualShaderNodeIntConstant|__visualshadernodetexturesdfnormal__.VisualShaderNodeTextureSDFNormal|__shadermaterial__.ShaderMaterial|__visualshadernodeintparameter__.VisualShaderNodeIntParameter|__animationnode__.AnimationNode|__styleboxtexture__.StyleBoxTexture|__texture__.Texture|__visualshadernodecurvexyztexture__.VisualShaderNodeCurveXYZTexture|__visualshadernodevec3parameter__.VisualShaderNodeVec3Parameter|__visualshadernodevectorcompose__.VisualShaderNodeVectorCompose|__navigationmesh__.NavigationMesh|__inputeventmidi__.InputEventMIDI|__animationnodesync__.AnimationNodeSync|__basematerial3d__.BaseMaterial3D|__primitivemesh__.PrimitiveMesh|__boxoccluder3d__.BoxOccluder3D|__noisetexture2d__.NoiseTexture2D|__gltfphysicsbody__.GLTFPhysicsBody|__compositoreffect__.CompositorEffect|__textmesh__.TextMesh|__compressedtexturelayered__.CompressedTextureLayered|__visualshadernodeintop__.VisualShaderNodeIntOp|__visualshadernodeuintparameter__.VisualShaderNodeUIntParameter|__visualshadernodetexture2darray__.VisualShaderNodeTexture2DArray|__audiostreammp3__.AudioStreamMP3|__inputeventscreentouch__.InputEventScreenTouch|__visualshadernodefloatparameter__.VisualShaderNodeFloatParameter|__curve3d__.Curve3D|__visualshadernodescreennormalworldspace__.VisualShaderNodeScreenNormalWorldSpace|__audioeffectstereoenhance__.AudioEffectStereoEnhance|__texture3drd__.Texture3DRD|__animationnodeadd3__.AnimationNodeAdd3|__shortcut__.Shortcut|__fontvariation__.FontVariation|__x509certificate__.X509Certificate|__audiostream__.AudioStream|__skeletonprofile__.SkeletonProfile|__curve__.Curve|__gdextension__.GDExtension|__visualshadernodecustom__.VisualShaderNodeCustom|__placeholdertexturelayered__.PlaceholderTextureLayered|__visualshadernodecolorparameter__.VisualShaderNodeColorParameter|__animationlibrary__.AnimationLibrary|__visualshadernodecolorfunc__.VisualShaderNodeColorFunc|__canvastexture__.CanvasTexture|__visualshadernodevaryinggetter__.VisualShaderNodeVaryingGetter|__shader__.Shader|__cameratexture__.CameraTexture|__visualshadernodetransformcompose__.VisualShaderNodeTransformCompose|__shape3d__.Shape3D|__audioeffectcompressor__.AudioEffectCompressor|__audioeffectamplify__.AudioEffectAmplify|__inputeventshortcut__.InputEventShortcut|__editorsettings__.EditorSettings|__openxripbindingmodifier__.OpenXRIPBindingModifier|__richtexteffect__.RichTextEffect|__visualshadernodeparticleemitter__.VisualShaderNodeParticleEmitter|__visualshadernodevec2constant__.VisualShaderNodeVec2Constant|__animationrootnode__.AnimationRootNode|__audiostreamrandomizer__.AudioStreamRandomizer|__tubetrailmesh__.TubeTrailMesh|__compressedcubemaparray__.CompressedCubemapArray|__animationnodeoneshot__.AnimationNodeOneShot|__videostreamplayback__.VideoStreamPlayback|__animationnodetransition__.AnimationNodeTransition|__audioeffecthighpassfilter__.AudioEffectHighPassFilter|__visualshadernodetextureparameter__.VisualShaderNodeTextureParameter|__externaltexture__.ExternalTexture|__font__.Font|__inputeventfromwindow__.InputEventFromWindow|__navigationmeshsourcegeometrydata3d__.NavigationMeshSourceGeometryData3D|__skeletonmodification2dfabrik__.SkeletonModification2DFABRIK|__visualshadernoderemap__.VisualShaderNodeRemap|__visualshadernodevectorop__.VisualShaderNodeVectorOp|__packeddatacontainer__.PackedDataContainer|__atlastexture__.AtlasTexture|__texture2d__.Texture2D|__imagetexturelayered__.ImageTextureLayered|__visualshadernodeuintfunc__.VisualShaderNodeUIntFunc|__compressedtexture2darray__.CompressedTexture2DArray|__missingresource__.MissingResource|__gltfspecgloss__.GLTFSpecGloss|__torusmesh__.TorusMesh|__physicsmaterial__.PhysicsMaterial|__audiostreammicrophone__.AudioStreamMicrophone|__arrayoccluder3d__.ArrayOccluder3D|__rectangleshape2d__.RectangleShape2D|__animatedtexture__.AnimatedTexture|__visualshadernodesample3d__.VisualShaderNodeSample3D|__skeletonmodificationstack2d__.SkeletonModificationStack2D|__visualshadernodefloatfunc__.VisualShaderNodeFloatFunc|__visualshadernodevec3constant__.VisualShaderNodeVec3Constant|__visualshadernodeparticleboxemitter__.VisualShaderNodeParticleBoxEmitter|__capsuleshape2d__.CapsuleShape2D|__visualshadernodevec4constant__.VisualShaderNodeVec4Constant|__visualshadernodeframe__.VisualShaderNodeFrame|__fbxstate__.FBXState|__animationnodeblendtree__.AnimationNodeBlendTree|__cubemaparray__.CubemapArray|__compressedcubemap__.CompressedCubemap|__visualshadernodemix__.VisualShaderNodeMix|__texturecubemaprd__.TextureCubemapRD|__visualshadernodeparticleaccelerator__.VisualShaderNodeParticleAccelerator|__world2d__.World2D|__visualshadernodetransformvecmult__.VisualShaderNodeTransformVecMult|__codehighlighter__.CodeHighlighter|__boxshape3d__.BoxShape3D|__visualshadernodesmoothstep__.VisualShaderNodeSmoothStep|__inputeventgesture__.InputEventGesture|__skin__.Skin|__concavepolygonshape2d__.ConcavePolygonShape2D|__audiostreampolyphonic__.AudioStreamPolyphonic|__cameraattributespractical__.CameraAttributesPractical|__visualshadernodecubemap__.VisualShaderNodeCubemap|__bitmap__.BitMap|__gltfdocument__.GLTFDocument|__cameraattributesphysical__.CameraAttributesPhysical|__skeletonmodification2dstackholder__.SkeletonModification2DStackHolder|__gltftexture__.GLTFTexture|__visualshadernoderesizablebase__.VisualShaderNodeResizableBase|__audioeffectfilter__.AudioEffectFilter|__cameraattributes__.CameraAttributes|__openxrhapticvibration__.OpenXRHapticVibration|__compressedtexture3d__.CompressedTexture3D|__skeletonmodification2dphysicalbones__.SkeletonModification2DPhysicalBones|__visualshadernodevectorrefract__.VisualShaderNodeVectorRefract|__environment__.Environment|__resource__.Resource|__separationrayshape3d__.SeparationRayShape3D|__compositor__.Compositor|__animationnodetimescale__.AnimationNodeTimeScale|__placeholdertexture2darray__.PlaceholderTexture2DArray|__noise__.Noise|__script__.Script|__animationnodeextension__.AnimationNodeExtension|__mesh__.Mesh|__inputeventaction__.InputEventAction|__navigationmeshsourcegeometrydata2d__.NavigationMeshSourceGeometryData2D|__visualshadernodevectorlen__.VisualShaderNodeVectorLen|__texturecubemaparrayrd__.TextureCubemapArrayRD|__fastnoiselite__.FastNoiseLite:
    """
  ...
  def _begin_customize_scenes(self, platform:__editorexportplatform__.EditorExportPlatform, features:__core__.PackedStringArray)->bool:
    """
  ...
  def _get_export_options(self, platform:__editorexportplatform__.EditorExportPlatform)->typedarray::Dictionary:
    """
  ...
  def _get_export_options_overrides(self, platform:__editorexportplatform__.EditorExportPlatform)->__core__.Dictionary:
    """
  ...
  def _should_update_export_options(self, platform:__editorexportplatform__.EditorExportPlatform)->bool:
    """
  ...
  def _get_export_option_visibility(self, platform:__editorexportplatform__.EditorExportPlatform, option:str)->bool:
    """
  ...
  def _get_export_option_warning(self, platform:__editorexportplatform__.EditorExportPlatform, option:str)->str:
    """
  ...
  def _get_export_features(self, platform:__editorexportplatform__.EditorExportPlatform, debug:bool)->__core__.PackedStringArray:
    """
  ...
  def _supports_platform(self, platform:__editorexportplatform__.EditorExportPlatform)->bool:
    """
				Return `true` if the plugin supports the given `platform`.
			"""
    pass

  def _get_android_dependencies(self, platform:__editorexportplatform__.EditorExportPlatform, debug:bool)->__core__.PackedStringArray:
    """
  ...
  def _get_android_dependencies_maven_repos(self, platform:__editorexportplatform__.EditorExportPlatform, debug:bool)->__core__.PackedStringArray:
    """
  ...
  def _get_android_libraries(self, platform:__editorexportplatform__.EditorExportPlatform, debug:bool)->__core__.PackedStringArray:
    """
  ...
  def _get_android_manifest_activity_element_contents(self, platform:__editorexportplatform__.EditorExportPlatform, debug:bool)->str:
    """
  ...
  def _get_android_manifest_application_element_contents(self, platform:__editorexportplatform__.EditorExportPlatform, debug:bool)->str:
    """
  ...
  def _get_android_manifest_element_contents(self, platform:__editorexportplatform__.EditorExportPlatform, debug:bool)->str:
    """
  ...
  def add_shared_object(self, path:str, tags:__core__.PackedStringArray, target:str)->None:
    """
  ...
  def add_file(self, path:str, file:__core__.PackedByteArray, remap:bool)->None:
    """
  ...
  def get_option(self, name:__core__.StringName|str)->Any:
    """
				Returns the current value of an export option supplied by `_get_export_options`.
			"""
    pass

  def get_export_preset(self)->__editorexportpreset__.EditorExportPreset:
    """
				Returns currently used export preset.
			"""
    pass

  def get_export_platform(self)->__editorexportplatformlinuxbsd__.EditorExportPlatformLinuxBSD|__editorexportplatformweb__.EditorExportPlatformWeb|__editorexportplatform__.EditorExportPlatform|__editorexportplatformmacos__.EditorExportPlatformMacOS|__editorexportplatformios__.EditorExportPlatformIOS|__editorexportplatformandroid__.EditorExportPlatformAndroid|__editorexportplatformextension__.EditorExportPlatformExtension|__editorexportplatformwindows__.EditorExportPlatformWindows|__editorexportplatformpc__.EditorExportPlatformPC:
    """
