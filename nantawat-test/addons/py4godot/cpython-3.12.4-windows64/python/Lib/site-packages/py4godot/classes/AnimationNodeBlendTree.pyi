...
class AnimationNodeBlendTree(__animationrootnode__.AnimationRootNode):
  ...
  @property
  def graph_offset(self)->__core__.Vector2:
    """"""
    pass
  @graph_offset.setter
  def graph_offset(self,  value:__core__.Vector2)->None:
    """"""
    pass
  ...
  def get_node(self, name:__core__.StringName|str)->__animationnodeblendspace1d__.AnimationNodeBlendSpace1D|__animationnodesync__.AnimationNodeSync|__animationnodeoneshot__.AnimationNodeOneShot|__animationnodeblendtree__.AnimationNodeBlendTree|__animationrootnode__.AnimationRootNode|__animationnodeblendspace2d__.AnimationNodeBlendSpace2D|__animationnodeadd3__.AnimationNodeAdd3|__animationnodestatemachine__.AnimationNodeStateMachine|__animationnodeextension__.AnimationNodeExtension|__animationnodetimeseek__.AnimationNodeTimeSeek|__animationnodesub2__.AnimationNodeSub2|__animationnodeoutput__.AnimationNodeOutput|__animationnodetransition__.AnimationNodeTransition|__animationnode__.AnimationNode|__animationnodeblend2__.AnimationNodeBlend2|__animationnodeanimation__.AnimationNodeAnimation|__animationnodeadd2__.AnimationNodeAdd2|__animationnodeblend3__.AnimationNodeBlend3|__animationnodetimescale__.AnimationNodeTimeScale:
    """
  ...
  def connect_node(self, input_node:__core__.StringName|str, input_index:int, output_node:__core__.StringName|str)->None:
    """
				Connects the output of an `AnimationNode` as input for another `AnimationNode`, at the input port specified by `input_index`.
			"""
    pass

  def disconnect_node(self, input_node:__core__.StringName|str, input_index:int)->None:
    """
