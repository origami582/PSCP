...
class NavigationLink2D(__node2d__.Node2D):
  ...
  def start_position(self,  value:__core__.Vector2)->None:
    ...
    pass
  @property
  def end_position(self)->__core__.Vector2:
    """"""
    pass
  @end_position.setter
  def end_position(self,  value:__core__.Vector2)->None:
    """"""
    pass
  @property
  ...
  def set_start_position(self, position:__core__.Vector2)->None:
    """"""
    pass
  ...
  def set_end_position(self, position:__core__.Vector2)->None:
    """"""
    pass

  def get_end_position(self)->__core__.Vector2:
    """"""
    pass

  def set_global_start_position(self, position:__core__.Vector2)->None:
    """
				Sets the `start_position` that is relative to the link from a global `position`.
			"""
    pass

  def get_global_start_position(self)->__core__.Vector2:
    """
				Returns the `start_position` that is relative to the link as a global position.
			"""
    pass

  def set_global_end_position(self, position:__core__.Vector2)->None:
    """
				Sets the `end_position` that is relative to the link from a global `position`.
			"""
    pass

  def get_global_end_position(self)->__core__.Vector2:
    """
