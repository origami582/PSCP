...
class AcceptDialog(__window__.Window):
  ...
  def dialog_autowrap(self,  value:bool)->None:
    """"""
    pass
  def get_ok_button(self)->__colorpickerbutton__.ColorPickerButton|__checkbutton__.CheckButton|__menubutton__.MenuButton|__button__.Button|__optionbutton__.OptionButton|__checkbox__.CheckBox:
    """
  ...
  def add_button(self, text:str, right:bool=False, action:str= __core__.String.new0())->__colorpickerbutton__.ColorPickerButton|__checkbutton__.CheckButton|__menubutton__.MenuButton|__button__.Button|__optionbutton__.OptionButton|__checkbox__.CheckBox:
    """
  ...
  def add_cancel_button(self, name:str)->__colorpickerbutton__.ColorPickerButton|__checkbutton__.CheckButton|__menubutton__.MenuButton|__button__.Button|__optionbutton__.OptionButton|__checkbox__.CheckBox:
    """
