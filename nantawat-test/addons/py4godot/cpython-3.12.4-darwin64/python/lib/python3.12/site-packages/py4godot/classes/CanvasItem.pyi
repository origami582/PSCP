...
class CanvasItem(__node__.Node):
  ...
  def make_input_local(self, event:__inputevent__.InputEvent)->__inputeventmidi__.InputEventMIDI|__inputeventscreendrag__.InputEventScreenDrag|__inputeventmagnifygesture__.InputEventMagnifyGesture|__inputeventjoypadbutton__.InputEventJoypadButton|__inputeventkey__.InputEventKey|__inputeventshortcut__.InputEventShortcut|__inputeventwithmodifiers__.InputEventWithModifiers|__inputeventjoypadmotion__.InputEventJoypadMotion|__inputeventpangesture__.InputEventPanGesture|__inputeventmousebutton__.InputEventMouseButton|__inputeventscreentouch__.InputEventScreenTouch|__inputeventgesture__.InputEventGesture|__inputeventfromwindow__.InputEventFromWindow|__inputevent__.InputEvent|__inputeventaction__.InputEventAction|__inputeventmouse__.InputEventMouse|__inputeventmousemotion__.InputEventMouseMotion:
    """
