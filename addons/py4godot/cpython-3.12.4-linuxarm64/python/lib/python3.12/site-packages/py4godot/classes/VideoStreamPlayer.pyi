...
class VideoStreamPlayer(__control__.Control):
  ...
  def audio_track(self,  value:int)->None:
    ...
    pass
  @property
  def stream(self)->__videostreamtheora__.VideoStreamTheora|__videostream__.VideoStream:
    """"""
    pass
  @stream.setter
  ...
  def get_stream(self)->__videostreamtheora__.VideoStreamTheora|__videostream__.VideoStream:
    """"""
    pass
