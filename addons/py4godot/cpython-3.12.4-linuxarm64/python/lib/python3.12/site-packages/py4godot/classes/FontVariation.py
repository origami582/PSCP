...
class FontVariation(py4godot_font.Font):
  ...
  @property
  def base_font(self) -> typing.Union['typing.Self','py4godot_font.Font','py4godot_fontfile.FontFile','py4godot_systemfont.SystemFont']:
    r''''''
  ...
  @functools.native_method
  def get_base_font(self) -> typing.Union['typing.Self','py4godot_font.Font','py4godot_fontfile.FontFile','py4godot_systemfont.SystemFont']:
    r''''''
