...
class GLTFDocumentExtension(__resource__.Resource):
  ...
  def _import_preflight(self, state:__gltfstate__.GLTFState, extensions:__core__.PackedStringArray)->int:
    """"""
    pass

  def _get_supported_extensions(self)->__core__.PackedStringArray:
    """"""
    pass

  def _parse_node_extensions(self, state:__gltfstate__.GLTFState, gltf_node:__gltfnode__.GLTFNode, extensions:__core__.Dictionary)->int:
    """"""
    pass

  def _parse_image_data(self, state:__gltfstate__.GLTFState, image_data:__core__.PackedByteArray, mime_type:str, ret_image:__image__.Image)->int:
    """"""
    pass
