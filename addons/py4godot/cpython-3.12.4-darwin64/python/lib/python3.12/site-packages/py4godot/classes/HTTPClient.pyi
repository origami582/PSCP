...
class HTTPClient(__refcounted__.RefCounted):
  ...
  def blocking_mode_enabled(self,  value:bool)->None:
    ...
    pass
  @property
  def connection(self)->__streampeertcp__.StreamPeerTCP|__streampeergzip__.StreamPeerGZIP|__streampeertls__.StreamPeerTLS|__streampeerextension__.StreamPeerExtension|__streampeer__.StreamPeer|__streampeerbuffer__.StreamPeerBuffer:
    """"""
    pass
  @connection.setter
  ...
  def get_connection(self)->__streampeertcp__.StreamPeerTCP|__streampeergzip__.StreamPeerGZIP|__streampeertls__.StreamPeerTLS|__streampeerextension__.StreamPeerExtension|__streampeer__.StreamPeer|__streampeerbuffer__.StreamPeerBuffer:
    """"""
    pass
