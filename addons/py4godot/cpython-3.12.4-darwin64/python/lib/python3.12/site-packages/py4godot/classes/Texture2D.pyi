...
class Texture2D(__texture__.Texture):
  ...
  def _draw(self, to_canvas_item:__core__.RID, pos:__core__.Vector2, modulate:__core__.Color, transpose:bool)->None:
    """
  ...
  def _draw_rect(self, to_canvas_item:__core__.RID, rect:__core__.Rect2, tile:bool, modulate:__core__.Color, transpose:bool)->None:
    """
  ...
  def _draw_rect_region(self, to_canvas_item:__core__.RID, rect:__core__.Rect2, src_rect:__core__.Rect2, modulate:__core__.Color, transpose:bool, clip_uv:bool)->None:
    """
  ...
  def draw(self, canvas_item:__core__.RID, position:__core__.Vector2, modulate:__core__.Color= __core__.Color.new0(), transpose:bool=False)->None:
    """
				Draws the texture using a `CanvasItem` with the `RenderingServer` API at the specified `position`.
			"""
    pass

  def draw_rect(self, canvas_item:__core__.RID, rect:__core__.Rect2, tile:bool, modulate:__core__.Color= __core__.Color.new0(), transpose:bool=False)->None:
    """
				Draws the texture using a `CanvasItem` with the `RenderingServer` API.
			"""
    pass

  def draw_rect_region(self, canvas_item:__core__.RID, rect:__core__.Rect2, src_rect:__core__.Rect2, modulate:__core__.Color= __core__.Color.new0(), transpose:bool=False, clip_uv:bool=True)->None:
    """
				Draws a part of the texture using a `CanvasItem` with the `RenderingServer` API.
			"""
    pass

  def get_image(self)->__image__.Image:
    """
