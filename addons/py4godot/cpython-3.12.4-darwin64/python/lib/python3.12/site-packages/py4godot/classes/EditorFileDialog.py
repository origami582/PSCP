...
class EditorFileDialog(py4godot_confirmationdialog.ConfirmationDialog):
  ...
  @functools.native_method
  def get_vbox(self) -> typing.Union['py4godot_scripteditorbase.ScriptEditorBase','py4godot_filesystemdock.FileSystemDock','py4godot_colorpicker.ColorPicker','py4godot_vboxcontainer.VBoxContainer']:
    r'''
