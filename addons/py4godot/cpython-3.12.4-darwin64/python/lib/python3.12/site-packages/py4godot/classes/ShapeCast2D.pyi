...
class ShapeCast2D(__node2d__.Node2D):
  ...
  def enabled(self,  value:bool)->None:
    ...
    pass
  @property
  def shape(self)->__capsuleshape2d__.CapsuleShape2D|__concavepolygonshape2d__.ConcavePolygonShape2D|__separationrayshape2d__.SeparationRayShape2D|__convexpolygonshape2d__.ConvexPolygonShape2D|__shape2d__.Shape2D|__circleshape2d__.CircleShape2D|__rectangleshape2d__.RectangleShape2D|__worldboundaryshape2d__.WorldBoundaryShape2D|__segmentshape2d__.SegmentShape2D:
    """"""
    pass
  @shape.setter
  ...
  def set_target_position(self, local_point:__core__.Vector2)->None:
    """"""
    pass
  ...
  def get_collision_point(self, index:int)->__core__.Vector2:
    """
  ...
  def get_collision_normal(self, index:int)->__core__.Vector2:
    """
  ...
  def add_exception(self, node:__collisionobject2d__.CollisionObject2D)->None:
    """
  ...
  def remove_exception(self, node:__collisionobject2d__.CollisionObject2D)->None:
    """
