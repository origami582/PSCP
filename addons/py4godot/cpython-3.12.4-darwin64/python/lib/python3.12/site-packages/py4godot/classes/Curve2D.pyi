...
class Curve2D(__resource__.Resource):
  ...
  def add_point(self, position:__core__.Vector2, in_:__core__.Vector2= __core__.Vector2.new0(), out:__core__.Vector2= __core__.Vector2.new0(), index:int=-1)->None:
    """
  ...
  def set_point_position(self, idx:int, position:__core__.Vector2)->None:
    """
				Sets the position for the vertex `idx`. If the index is out of bounds, the function sends an error to the console.
			"""
    pass

  def get_point_position(self, idx:int)->__core__.Vector2:
    """
				Returns the position of the vertex `idx`. If the index is out of bounds, the function sends an error to the console, and returns `(0, 0)`.
			"""
    pass

  def set_point_in(self, idx:int, position:__core__.Vector2)->None:
    """
				Sets the position of the control point leading to the vertex `idx`. If the index is out of bounds, the function sends an error to the console. The position is relative to the vertex.
			"""
    pass

  def get_point_in(self, idx:int)->__core__.Vector2:
    """
  ...
  def set_point_out(self, idx:int, position:__core__.Vector2)->None:
    """
				Sets the position of the control point leading out of the vertex `idx`. If the index is out of bounds, the function sends an error to the console. The position is relative to the vertex.
			"""
    pass

  def get_point_out(self, idx:int)->__core__.Vector2:
    """
  ...
  def sample(self, idx:int, t:float)->__core__.Vector2:
    """
  ...
  def samplef(self, fofs:float)->__core__.Vector2:
    """
  ...
  def sample_baked(self, offset:float=0.0, cubic:bool=False)->__core__.Vector2:
    """
  ...
  def sample_baked_with_rotation(self, offset:float=0.0, cubic:bool=False)->__core__.Transform2D:
    """
  ...
  def get_baked_points(self)->__core__.PackedVector2Array:
    """
				Returns the cache of points as a `PackedVector2Array`.
			"""
    pass

  def get_closest_point(self, to_point:__core__.Vector2)->__core__.Vector2:
    """
  ...
  def get_closest_offset(self, to_point:__core__.Vector2)->float:
    """
  ...
  def tessellate(self, max_stages:int=5, tolerance_degrees:float=4)->__core__.PackedVector2Array:
    """
  ...
  def tessellate_even_length(self, max_stages:int=5, tolerance_length:float=20.0)->__core__.PackedVector2Array:
    """
