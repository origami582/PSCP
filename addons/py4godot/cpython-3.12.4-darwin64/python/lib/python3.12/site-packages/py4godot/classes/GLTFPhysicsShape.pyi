...
class GLTFPhysicsShape(__resource__.Resource):
  ...
  def mesh_index(self)->int:
    ...
    pass
  @mesh_index.setter
  def mesh_index(self,  value:int)->None:
    """"""
    pass
  @property
  def importer_mesh(self)->__importermesh__.ImporterMesh:
    """"""
    pass
  @importer_mesh.setter
  def importer_mesh(self,  value:__importermesh__.ImporterMesh)->None:
    """"""
    pass
  @staticmethod
  def from_node(shape_node:__collisionshape3d__.CollisionShape3D)->__gltfphysicsshape__.GLTFPhysicsShape:
    """"""
    pass

  def to_node(self, cache_shapes:bool=False)->__collisionshape3d__.CollisionShape3D:
    """"""
    pass

  @staticmethod
  def from_resource(shape_resource:__shape3d__.Shape3D)->__gltfphysicsshape__.GLTFPhysicsShape:
    """"""
    pass

  def to_resource(self, cache_shapes:bool=False)->__convexpolygonshape3d__.ConvexPolygonShape3D|__sphereshape3d__.SphereShape3D|__capsuleshape3d__.CapsuleShape3D|__concavepolygonshape3d__.ConcavePolygonShape3D|__cylindershape3d__.CylinderShape3D|__worldboundaryshape3d__.WorldBoundaryShape3D|__boxshape3d__.BoxShape3D|__shape3d__.Shape3D|__heightmapshape3d__.HeightMapShape3D|__separationrayshape3d__.SeparationRayShape3D:
    """"""
    pass

  @staticmethod
  def from_dictionary(dictionary:__core__.Dictionary)->__gltfphysicsshape__.GLTFPhysicsShape:
    """"""
    pass
  ...
  def get_importer_mesh(self)->__importermesh__.ImporterMesh:
    """"""
    pass

  def set_importer_mesh(self, importer_mesh:__importermesh__.ImporterMesh)->None:
    """"""
    pass
