...
class NavigationPathQueryResult3D(__refcounted__.RefCounted):
  ...
  @property
  def path(self)->__core__.PackedVector3Array:
    """"""
    pass
  @path.setter
  def path(self,  value:__core__.PackedVector3Array)->None:
    """"""
    pass
  @property
  ...
  def path_owner_ids(self,  value:__core__.PackedInt64Array)->None:
    """"""
    pass
  def set_path(self, path:__core__.PackedVector3Array)->None:
    """"""
    pass

  def get_path(self)->__core__.PackedVector3Array:
    """"""
    pass
