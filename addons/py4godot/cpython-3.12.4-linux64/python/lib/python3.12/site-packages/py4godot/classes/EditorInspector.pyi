...
class EditorInspector(__scrollcontainer__.ScrollContainer):
  ...
  def edit(self, object:__object__.Object)->None:
    """
  ...
  @staticmethod
  def instantiate_property_editor(object:__object__.Object, type:int , path:str, hint:int , hint_text:str, usage:int, wide:bool=False)->__editorproperty__.EditorProperty:
    """
