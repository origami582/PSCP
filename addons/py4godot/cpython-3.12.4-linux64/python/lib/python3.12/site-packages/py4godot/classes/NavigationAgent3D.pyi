...
class NavigationAgent3D(__node__.Node):
  ...
  def target_desired_distance(self,  value:float)->None:
    ...
    pass
  @property
  def path_height_offset(self)->float:
    """"""
    pass
  @path_height_offset.setter
  def path_height_offset(self,  value:float)->None:
    """"""
    pass
  @property
  ...
  def use_3d_avoidance(self,  value:bool)->None:
    ...
    pass
  @property
  def keep_y_velocity(self)->bool:
    """"""
    pass
  @keep_y_velocity.setter
  def keep_y_velocity(self,  value:bool)->None:
    """"""
    pass
  @property
  ...
  def set_target_position(self, position:__core__.Vector3)->None:
    """"""
    pass
  ...
  def get_next_path_position(self)->__core__.Vector3:
    """
				Returns the next position in global coordinates that can be moved to, making sure that there are no static objects in the way. If the agent does not have a navigation path, it will return the position of the agent's parent. The use of this function once every physics frame is required to update the internal path logic of the NavigationAgent.
			"""
    pass

  def set_velocity_forced(self, velocity:__core__.Vector3)->None:
    """
  ...
  def get_current_navigation_result(self)->__navigationpathqueryresult3d__.NavigationPathQueryResult3D:
    """
				Returns the path query result for the path the agent is currently following.
			"""
    pass

  def get_current_navigation_path(self)->__core__.PackedVector3Array:
    """
  ...
  def get_final_position(self)->__core__.Vector3:
    """
