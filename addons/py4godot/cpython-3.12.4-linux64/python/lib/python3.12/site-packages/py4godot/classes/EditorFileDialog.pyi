...
class EditorFileDialog(__confirmationdialog__.ConfirmationDialog):
  ...
  def show_hidden_files(self,  value:bool)->None:
    ...
    pass
  @property
  def disable_overwrite_warning(self)->bool:
    """"""
    pass
  @disable_overwrite_warning.setter
  def disable_overwrite_warning(self,  value:bool)->None:
    """"""
    pass
  ...
  def get_vbox(self)->__filesystemdock__.FileSystemDock|__scripteditorbase__.ScriptEditorBase|__colorpicker__.ColorPicker|__vboxcontainer__.VBoxContainer:
    """
  ...
  def add_side_menu(self, menu:__control__.Control, title:str= __core__.String.new0())->None:
    """
