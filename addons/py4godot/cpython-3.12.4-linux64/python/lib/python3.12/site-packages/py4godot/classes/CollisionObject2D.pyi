...
class CollisionObject2D(__node2d__.Node2D):
  ...
  def collision_priority(self,  value:float)->None:
    ...
    pass
  @property
  def input_pickable(self)->bool:
    """"""
    pass
  @input_pickable.setter
  def input_pickable(self,  value:bool)->None:
    """"""
    pass
  def _input_event(self, viewport:__viewport__.Viewport, event:__inputevent__.InputEvent, shape_idx:int)->None:
    """
  ...
  def shape_owner_set_transform(self, owner_id:int, transform:__core__.Transform2D)->None:
    """
				Sets the `Transform2D` of the given shape owner.
			"""
    pass

  def shape_owner_get_transform(self, owner_id:int)->__core__.Transform2D:
    """
  ...
  def shape_owner_add_shape(self, owner_id:int, shape:__shape2d__.Shape2D)->None:
    """
