...
"""
  ...
  def _make_template(self, template:str, class_name:str, base_class_name:str)->__script__.Script|__gdscript__.GDScript|__scriptextension__.ScriptExtension:
    """
"""
    pass
