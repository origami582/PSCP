...
class ProjectSettings(__object__.Object):
  ...
  def get_setting(self, name:str, default_value:Any=None)->Any:
    """
  ...
  def get_setting_with_override(self, name:__core__.StringName|str)->Any:
    """
  ...
  def get_global_class_list(self)->typedarray::Dictionary:
    """
  ...
  def set_initial_value(self, name:str, value:Any)->None:
    """
  ...
  def add_property_info(self, hint:__core__.Dictionary)->None:
    """
  ...
  def save_custom(self, file:str)->int:
    """
