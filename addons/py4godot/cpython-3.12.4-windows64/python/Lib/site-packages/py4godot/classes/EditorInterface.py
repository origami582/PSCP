...
class EditorInterface(py4godot_object.Object):
  ...
  @functools.native_method
  def get_editor_main_screen(self) -> typing.Union['py4godot_scripteditorbase.ScriptEditorBase','py4godot_filesystemdock.FileSystemDock','py4godot_colorpicker.ColorPicker','py4godot_vboxcontainer.VBoxContainer']:
    r'''
  ...
  def popup_node_selector(self, callback:'Callable'   , valid_types:'py4godot_stringnametypedarray.StringNameTypedArray' = None  , current_value:'py4godot_node.Node' = None  ) -> None:
    ...
    if current_value is None:
      current_value = py4godot_node.Node.constructor()
