...
class ConfirmationDialog(__acceptdialog__.AcceptDialog):
  ...
  def cancel_button_text(self,  value:str)->None:
    """"""
    pass
  def get_cancel_button(self)->__colorpickerbutton__.ColorPickerButton|__checkbutton__.CheckButton|__menubutton__.MenuButton|__button__.Button|__optionbutton__.OptionButton|__checkbox__.CheckBox:
    """
