...
class Camera3D(__node3d__.Node3D):
  ...
  def get_attributes(self)->__cameraattributespractical__.CameraAttributesPractical|__cameraattributes__.CameraAttributes|__cameraattributesphysical__.CameraAttributesPhysical:
    """"""
    pass
