...
class Resource(__refcounted__.RefCounted):
  ...
  @property
  def resource_local_to_scene(self)->bool:
    """"""
    pass
  @resource_local_to_scene.setter
  def resource_local_to_scene(self,  value:bool)->None:
    """"""
    pass
  @property
  ...
  def resource_path(self,  value:str)->None:
    """"""
    pass
  @property
  ...
  def resource_name(self,  value:str)->None:
    ...
    pass
  @property
  def resource_scene_unique_id(self)->str:
    """"""
    pass
  @resource_scene_unique_id.setter
  def resource_scene_unique_id(self,  value:str)->None:
    """"""
    pass
  ...
  def _get_rid(self)->__core__.RID:
    """
