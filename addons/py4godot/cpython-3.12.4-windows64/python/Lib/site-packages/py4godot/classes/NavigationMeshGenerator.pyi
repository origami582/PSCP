...
class NavigationMeshGenerator(__object__.Object):
  ...
  def bake(self, navigation_mesh:__navigationmesh__.NavigationMesh, root_node:__node__.Node)->None:
    """
				Bakes the `navigation_mesh` with source geometry collected starting from the `root_node`.
			"""
    pass

  def clear(self, navigation_mesh:__navigationmesh__.NavigationMesh)->None:
    """
