...
class EditorExportPlugin(__refcounted__.RefCounted):
  ...
  def get_export_platform(self)->__editorexportplatformios__.EditorExportPlatformIOS|__editorexportplatformandroid__.EditorExportPlatformAndroid|__editorexportplatform__.EditorExportPlatform|__editorexportplatformpc__.EditorExportPlatformPC|__editorexportplatformlinuxbsd__.EditorExportPlatformLinuxBSD|__editorexportplatformwindows__.EditorExportPlatformWindows|__editorexportplatformweb__.EditorExportPlatformWeb|__editorexportplatformmacos__.EditorExportPlatformMacOS|__editorexportplatformextension__.EditorExportPlatformExtension:
    """
