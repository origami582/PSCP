...
class AudioStreamRandomizer(__audiostream__.AudioStream):
  ...
  def get_stream(self, index:int)->__audiostream__.AudioStream|__audiostreamoggvorbis__.AudioStreamOggVorbis|__audiostreamsynchronized__.AudioStreamSynchronized|__audiostreamwav__.AudioStreamWAV|__audiostreamgenerator__.AudioStreamGenerator|__audiostreammicrophone__.AudioStreamMicrophone|__audiostreaminteractive__.AudioStreamInteractive|__audiostreamrandomizer__.AudioStreamRandomizer|__audiostreammp3__.AudioStreamMP3|__audiostreampolyphonic__.AudioStreamPolyphonic|__audiostreamplaylist__.AudioStreamPlaylist:
    """
