...
class StreamPeerTLS(__streampeer__.StreamPeer):
  ...
  def get_stream(self)->__streampeertcp__.StreamPeerTCP|__streampeergzip__.StreamPeerGZIP|__streampeertls__.StreamPeerTLS|__streampeer__.StreamPeer|__streampeerextension__.StreamPeerExtension|__streampeerbuffer__.StreamPeerBuffer:
    """
