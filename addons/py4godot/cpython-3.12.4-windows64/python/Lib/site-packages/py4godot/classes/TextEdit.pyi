...
class TextEdit(__control__.Control):
  ...
  def custom_word_separators(self,  value:str)->None:
    ...
    pass
  @property
  def syntax_highlighter(self)->__syntaxhighlighter__.SyntaxHighlighter|__codehighlighter__.CodeHighlighter|__editorsyntaxhighlighter__.EditorSyntaxHighlighter|__gdscriptsyntaxhighlighter__.GDScriptSyntaxHighlighter:
    """"""
    pass
  ...
  def get_syntax_highlighter(self)->__syntaxhighlighter__.SyntaxHighlighter|__codehighlighter__.CodeHighlighter|__editorsyntaxhighlighter__.EditorSyntaxHighlighter|__gdscriptsyntaxhighlighter__.GDScriptSyntaxHighlighter:
    """"""
    pass
