...
class RenderDataExtension(__renderdata__.RenderData):
  ...
  def _get_render_scene_data(self)->__renderscenedataextension__.RenderSceneDataExtension|__renderscenedatard__.RenderSceneDataRD|__renderscenedata__.RenderSceneData:
    """
