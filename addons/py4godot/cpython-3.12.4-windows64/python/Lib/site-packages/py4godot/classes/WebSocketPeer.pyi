...
class WebSocketPeer(__packetpeer__.PacketPeer):
  ...
  def heartbeat_interval(self,  value:int)->None:
    """"""
    pass
  def connect_to_url(self, url:str, tls_client_options:__tlsoptions__.TLSOptions= __tlsoptions__.TLSOptions.constructor())->int:
    """"""
    pass

  def accept_stream(self, stream:__streampeer__.StreamPeer)->int:
    """"""
    pass

  def send(self, message:__core__.PackedByteArray, write_mode:int =1)->int:
    """"""
    pass
  ...
  def close(self, code:int=1000, reason:str= __core__.String.new0())->None:
    """"""
    pass
