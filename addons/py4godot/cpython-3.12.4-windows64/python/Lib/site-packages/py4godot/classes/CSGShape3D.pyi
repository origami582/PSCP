...
class CSGShape3D(__geometryinstance3d__.GeometryInstance3D):
  ...
  def snap(self,  value:float)->None:
    ...
    pass
  @property
  def calculate_tangents(self)->bool:
    """"""
    pass
  ...
  def use_collision(self,  value:bool)->None:
    """"""
    pass
  @property
  ...
  def bake_static_mesh(self)->__arraymesh__.ArrayMesh:
    """"""
    pass

  def bake_collision_shape(self)->__concavepolygonshape3d__.ConcavePolygonShape3D:
    """"""
    pass
