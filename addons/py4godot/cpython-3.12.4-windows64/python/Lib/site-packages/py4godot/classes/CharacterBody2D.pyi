...
class CharacterBody2D(__physicsbody2d__.PhysicsBody2D):
  ...
  def motion_mode(self,  value:int)->None:
    ...
    pass
  @property
  def up_direction(self)->__core__.Vector2:
    """"""
    pass
  @up_direction.setter
  def up_direction(self,  value:__core__.Vector2)->None:
    """"""
    pass
  @property
  ...
  def get_up_direction(self)->__core__.Vector2:
    """"""
    pass

  def set_up_direction(self, up_direction:__core__.Vector2)->None:
    """"""
    pass
  ...
  def get_floor_normal(self)->__core__.Vector2:
    """
  ...
  def get_wall_normal(self)->__core__.Vector2:
    """
  ...
  def get_last_motion(self)->__core__.Vector2:
    """
  ...
  def get_position_delta(self)->__core__.Vector2:
    """
				Returns the travel (position delta) that occurred during the last call to `move_and_slide`.
			"""
    pass

  def get_real_velocity(self)->__core__.Vector2:
    """
  ...
  def get_floor_angle(self, up_direction:__core__.Vector2= __core__.Vector2.new0())->float:
    """
  ...
  def get_platform_velocity(self)->__core__.Vector2:
    """
  ...
  def get_slide_collision(self, slide_idx:int)->__kinematiccollision2d__.KinematicCollision2D:
    """
  ...
  def get_last_slide_collision(self)->__kinematiccollision2d__.KinematicCollision2D:
    """
