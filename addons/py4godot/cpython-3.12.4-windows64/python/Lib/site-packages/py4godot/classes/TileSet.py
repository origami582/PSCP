...
class TileSet(py4godot_resource.Resource):
  ...
  @functools.native_method
  def get_source(self, source_id:'int'   ) -> typing.Union['py4godot_tilesetatlassource.TileSetAtlasSource','py4godot_tilesetsource.TileSetSource','py4godot_tilesetscenescollectionsource.TileSetScenesCollectionSource']:
    r'''
