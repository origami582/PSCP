...
class ShaderMaterial(py4godot_material.Material):
  ...
  @property
  def shader(self) -> typing.Union['py4godot_visualshader.VisualShader','py4godot_shader.Shader']:
    r''''''
  ...
  @functools.native_method
  def get_shader(self) -> typing.Union['py4godot_visualshader.VisualShader','py4godot_shader.Shader']:
    r''''''
