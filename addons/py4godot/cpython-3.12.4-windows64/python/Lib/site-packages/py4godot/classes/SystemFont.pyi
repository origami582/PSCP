...
class SystemFont(__font__.Font):
  ...
  @property
  def font_names(self)->__core__.PackedStringArray:
    """"""
    pass
  @font_names.setter
  def font_names(self,  value:__core__.PackedStringArray)->None:
    """"""
    pass
  @property
  ...
  def get_font_names(self)->__core__.PackedStringArray:
    """"""
    pass

  def set_font_names(self, names:__core__.PackedStringArray)->None:
    """"""
    pass
