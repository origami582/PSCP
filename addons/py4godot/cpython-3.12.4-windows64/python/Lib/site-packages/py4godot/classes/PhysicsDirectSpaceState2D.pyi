...
class PhysicsDirectSpaceState2D(__object__.Object):
  ...
  def intersect_point(self, parameters:__physicspointqueryparameters2d__.PhysicsPointQueryParameters2D, max_results:int=32)->typedarray::Dictionary:
    """
  ...
  def intersect_ray(self, parameters:__physicsrayqueryparameters2d__.PhysicsRayQueryParameters2D)->__core__.Dictionary:
    """
  ...
  def intersect_shape(self, parameters:__physicsshapequeryparameters2d__.PhysicsShapeQueryParameters2D, max_results:int=32)->typedarray::Dictionary:
    """
  ...
  def cast_motion(self, parameters:__physicsshapequeryparameters2d__.PhysicsShapeQueryParameters2D)->__core__.PackedFloat32Array:
    """
  ...
  def collide_shape(self, parameters:__physicsshapequeryparameters2d__.PhysicsShapeQueryParameters2D, max_results:int=32)->typedarray::Vector2:
    """
  ...
  def get_rest_info(self, parameters:__physicsshapequeryparameters2d__.PhysicsShapeQueryParameters2D)->__core__.Dictionary:
    """
