...
class AnimationNodeBlendSpace1D(__animationrootnode__.AnimationRootNode):
  ...
  def min_space(self)->float:
    ...
    pass
  @min_space.setter
  def min_space(self,  value:float)->None:
    """"""
    pass
  @property
  def max_space(self)->float:
    """"""
    pass
  @max_space.setter
  def max_space(self,  value:float)->None:
    """"""
    pass
  @property
  def snap(self)->float:
  ...
  def value_label(self)->str:
    ...
    pass
  @value_label.setter
  def value_label(self,  value:str)->None:
    """"""
    pass
  @property
  ...
  def sync(self,  value:bool)->None:
    """"""
    pass
  def add_blend_point(self, node:__animationrootnode__.AnimationRootNode, pos:float, at_index:int=-1)->None:
    """
