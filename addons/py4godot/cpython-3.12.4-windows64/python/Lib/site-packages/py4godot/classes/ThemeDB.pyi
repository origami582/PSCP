...
class ThemeDB(__object__.Object):
  ...
  @property
  def fallback_base_scale(self)->float:
    """"""
    pass
  @fallback_base_scale.setter
  def fallback_base_scale(self,  value:float)->None:
    """"""
    pass
  @property
  def fallback_font(self)->__fontfile__.FontFile|__fontvariation__.FontVariation|__systemfont__.SystemFont|__font__.Font:
    """"""
    pass
  @fallback_font.setter
  def fallback_font(self,  value:__font__.Font)->None:
    """"""
    pass
  @property
  def fallback_font_size(self)->int:
    """"""
    pass
  @fallback_font_size.setter
  def fallback_font_size(self,  value:int)->None:
    """"""
    pass
  @property
  def fallback_icon(self)->__noisetexture2d__.NoiseTexture2D|__texture2d__.Texture2D|__viewporttexture__.ViewportTexture|__placeholdertexture2d__.PlaceholderTexture2D|__atlastexture__.AtlasTexture|__gradienttexture1d__.GradientTexture1D|__animatedtexture__.AnimatedTexture|__imagetexture__.ImageTexture|__portablecompressedtexture2d__.PortableCompressedTexture2D|__compressedtexture2d__.CompressedTexture2D|__canvastexture__.CanvasTexture|__texture2drd__.Texture2DRD|__curvetexture__.CurveTexture|__externaltexture__.ExternalTexture|__meshtexture__.MeshTexture|__gradienttexture2d__.GradientTexture2D|__curvexyztexture__.CurveXYZTexture|__cameratexture__.CameraTexture:
    """"""
    pass
  @fallback_icon.setter
  def fallback_icon(self,  value:__texture2d__.Texture2D)->None:
    """"""
    pass
  @property
  def fallback_stylebox(self)->__styleboxline__.StyleBoxLine|__styleboxempty__.StyleBoxEmpty|__styleboxtexture__.StyleBoxTexture|__stylebox__.StyleBox|__styleboxflat__.StyleBoxFlat:
    """"""
    pass
  @fallback_stylebox.setter
  def fallback_stylebox(self,  value:__stylebox__.StyleBox)->None:
    """"""
    pass
  def get_default_theme(self)->__theme__.Theme:
    """
  ...
  def get_project_theme(self)->__theme__.Theme:
    """
  ...
  def set_fallback_font(self, font:__font__.Font)->None:
    """"""
    pass

  def get_fallback_font(self)->__fontfile__.FontFile|__fontvariation__.FontVariation|__systemfont__.SystemFont|__font__.Font:
    """"""
    pass
  ...
  def set_fallback_icon(self, icon:__texture2d__.Texture2D)->None:
    """"""
    pass

  def get_fallback_icon(self)->__noisetexture2d__.NoiseTexture2D|__texture2d__.Texture2D|__viewporttexture__.ViewportTexture|__placeholdertexture2d__.PlaceholderTexture2D|__atlastexture__.AtlasTexture|__gradienttexture1d__.GradientTexture1D|__animatedtexture__.AnimatedTexture|__imagetexture__.ImageTexture|__portablecompressedtexture2d__.PortableCompressedTexture2D|__compressedtexture2d__.CompressedTexture2D|__canvastexture__.CanvasTexture|__texture2drd__.Texture2DRD|__curvetexture__.CurveTexture|__externaltexture__.ExternalTexture|__meshtexture__.MeshTexture|__gradienttexture2d__.GradientTexture2D|__curvexyztexture__.CurveXYZTexture|__cameratexture__.CameraTexture:
    """"""
    pass

  def set_fallback_stylebox(self, stylebox:__stylebox__.StyleBox)->None:
    """"""
    pass

  def get_fallback_stylebox(self)->__styleboxline__.StyleBoxLine|__styleboxempty__.StyleBoxEmpty|__styleboxtexture__.StyleBoxTexture|__stylebox__.StyleBox|__styleboxflat__.StyleBoxFlat:
    """"""
    pass
