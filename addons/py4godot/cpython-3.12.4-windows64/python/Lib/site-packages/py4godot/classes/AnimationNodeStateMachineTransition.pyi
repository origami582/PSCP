...
class AnimationNodeStateMachineTransition(__resource__.Resource):
  ...
  def switch_mode(self)->int:
    ...
    pass
  @switch_mode.setter
  def switch_mode(self,  value:int)->None:
    """"""
    pass
  @property
  def advance_mode(self)->int:
    """"""
    pass
  @advance_mode.setter
  def advance_mode(self,  value:int)->None:
    """"""
    pass
  @property
  def advance_condition(self)->__core__.StringName:
    """"""
    pass
  @advance_condition.setter
  def advance_condition(self,  value:__core__.StringName)->None:
    """"""
    pass
  @property
  def advance_expression(self)->str:
    """"""
    pass
  @advance_expression.setter
  def advance_expression(self,  value:str)->None:
    """"""
    pass
  ...
  def set_advance_condition(self, name:__core__.StringName|str)->None:
    """"""
    pass

  def get_advance_condition(self)->__core__.StringName:
    """"""
    pass
