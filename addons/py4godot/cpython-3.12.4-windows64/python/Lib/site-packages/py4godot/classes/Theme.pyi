...
class Theme(__resource__.Resource):
  ...
  def default_base_scale(self,  value:float)->None:
    ...
    pass
  @property
  def default_font(self)->__fontfile__.FontFile|__fontvariation__.FontVariation|__systemfont__.SystemFont|__font__.Font:
    """"""
    pass
  @default_font.setter
  ...
  def get_stylebox(self, name:__core__.StringName|str, theme_type:__core__.StringName|str)->__styleboxline__.StyleBoxLine|__styleboxempty__.StyleBoxEmpty|__styleboxtexture__.StyleBoxTexture|__stylebox__.StyleBox|__styleboxflat__.StyleBoxFlat:
    """
  ...
  def get_font(self, name:__core__.StringName|str, theme_type:__core__.StringName|str)->__fontfile__.FontFile|__fontvariation__.FontVariation|__systemfont__.SystemFont|__font__.Font:
    """
  ...
  def get_default_font(self)->__fontfile__.FontFile|__fontvariation__.FontVariation|__systemfont__.SystemFont|__font__.Font:
    """"""
    pass
