...
class ButtonGroup(__resource__.Resource):
  ...
  @property
  def allow_unpress(self)->bool:
    """"""
    pass
  @allow_unpress.setter
  def allow_unpress(self,  value:bool)->None:
    """"""
    pass
  def get_pressed_button(self)->__colorpickerbutton__.ColorPickerButton|__checkbutton__.CheckButton|__basebutton__.BaseButton|__menubutton__.MenuButton|__button__.Button|__texturebutton__.TextureButton|__optionbutton__.OptionButton|__checkbox__.CheckBox|__linkbutton__.LinkButton:
    """
				Returns the current pressed button.
			"""
    pass

  def get_buttons(self)->typedarray::BaseButton:
    """
